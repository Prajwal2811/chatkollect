									...
									<div class="col-xl-6 col-lg-6 mb-4">
										...
										<div class="card shadow-sm border-0 h-100">
											...
											<div class="card-footer bg-light">
												...
												<a href="{{ route('accountant.tally.company.ledgers', urlencode($company['name'])) }}"
												class="btn btn-sm btn-primary">
													<i class="fas fa-book"></i>
													Ledgers
												</a>

												<a href="{{ route('accountant.tally.company.ledgers-assign', urlencode($company['name'])) }}"
						 ...
						 <script>
							$(document).ready(function () {
								...
								$('#syncTallyBtn').click(function () {
									...
									$.ajax({
										url: "{{ route('accountant.tally.sync-all') }}",
										type: "POST",
										data: {
											_token: "{{ csrf_token() }}"
										},
