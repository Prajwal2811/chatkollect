...
$cards = [
    [
        'title' => $under === 'Sundry Creditors'
            ? 'Total Credit (Purchase + Others)'
            : 'Total Debit (Sales + Others)',
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 fw-bold">
                                ₹ {{ number_format(collect($lastYearOutstanding)->sum('pending'),2) }}
                            </h4>
                        </div>
...
<div class="card mt-3">
    ...
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tbody>
            @forelse($lastYearOutstanding as $row)
                <tr>
