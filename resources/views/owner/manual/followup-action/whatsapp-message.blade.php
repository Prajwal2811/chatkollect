@php
    ...
    // Human-readable labels for WhatsApp templates (owner assigns template_1, template_2, ... at allocate time)
    $templateLabels = [
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <h4 class="card-title mb-0">Whatsapp Message - Assigned Students</h4>
                                    <small class="text-muted">
                                        Students allocated for tele calling
                                    </small>
                                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="example13" class="table table-bordered table-striped align-middle">
                                        ...
                                        @forelse($teleCallData as $row)
                                            ...
                                            @php
                                                $rowTemplateLabel = !empty($row['template']) ? ($templateLabels[$row['template']] ?? $row['template']) : null;
                                            @endphp

                                            <tr data-type="{{ $row['type'] ?? '' }}" data-template="{{ $rowTemplateLabel ?? '-' }}">
                                                ...
                                                <td>
                                                    @if($rowTemplateLabel)
                                                        <span class="badge template-pill">{{ $rowTemplateLabel }}</span>
                                                    @else
                                                        -
                                                    @endif
                                                </td>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <strong>Student Name:</strong> <span id="logModalName">-</span>
                            </div>
                            <div class="col-md-6">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelectorAll('.view-log').forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        ...
                        document.getElementById('logModalName').textContent = rowData.student_name ?? '-';
                ...
                function renderLogTable(logs) {
                    ...
                    if (!logs || logs.length === 0) {
                        tbody.innerHTML = `<tr><td colspan="9" class="text-center">No log entries found</td></tr>`;
                        return;
                    }
